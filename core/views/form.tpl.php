<form class="form" method="POST" enctype="multipart/form-data">
    ...
    <!-- Buttons -->
    <?php if (isset($view['buttons'])): ?>
        <?php foreach ($view['buttons'] as $button_id => $button): ?>
            <button class="btn btn-dark" name="action" value="<?php print $button_id; ?>">
    ...
    <!-- Input Submit -->
    <?php if (isset($view['inputs'])): ?>
        <?php foreach ($view['inputs'] as $input_id => $input): ?>
            <input id="input-button" class="btn btn-dark" type="<?php print $input_id; ?>"
